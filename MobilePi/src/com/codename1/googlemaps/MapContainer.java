...
public class MapContainer extends com.codename1.ui.Container {
	...
	/**
	 *  change map size
	 *  @param height preferred map height percentage (int)
	 *  @param width preferred map percentage (int)
	 */
	public void setmapSize(int height, int width) {
	}

	/**
	 *  create route in the map and change camera position to that route
	 *  @param from the starting position
	 *  @param to the destination
	 */
	public void calculateAndDisplayAnnonceRoute(String from, String to) {
	}
